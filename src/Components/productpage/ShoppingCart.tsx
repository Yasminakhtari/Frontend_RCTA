...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100 p-4 sm:p-8 mt-6">
      ...
      {cart.length === 0 ? (
        ...
        <div>
          {cart.map((product) => {
            ...
            return (
              <div key={product.id} className="mb-4 p-4 bg-white shadow-md rounded-lg">
                <h2 className="text-lg font-semibold">{product.name}</h2>
                <p className="mb-1 sm:mb-2">Price per item: ${product.price.toFixed(2)}</p>
                <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-2 sm:space-y-0">
                  <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                    ...
                    <h2 className="text-gray-700 sm:mt-0 mt-2">Total: ${productTotal.toFixed(2)}</h2>
                  </div>
                  <button
