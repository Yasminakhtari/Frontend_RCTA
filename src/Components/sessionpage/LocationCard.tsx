...
const LocationCard: React.FC<LocationCardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-blue-800 to-blue-600 text-white rounded-xl shadow-lg p-6 hover:shadow-2xl transition-shadow duration-300 w-64 h-48 sm:w-72 sm:h-56">
      <h3 className="text-xl font-semibold mb-2">{locationName}</h3>
      <p className="text-sm">{address}</p>
      <p className="text-sm">
        {city}, {state}
